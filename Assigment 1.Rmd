...
The mean of steps taken per day is `r meanA` and the median is `r medianA`
...
>*The missig row number is: `r missingRows`*
...
>The new mean mean is `r meanB` and the new median is `r medianB`. The difference is in mean `r diffMean` and in median `r diffMedian`.  
